...
toolId = doublePlus(appDataStruct.figureHandle,appDataStruct.figureHandle); 
toolId = doublePlus(toolId,appDataStruct.mainAxesHandle); 
toolId = doublePlus(toolId,appDataStruct.magnifierHandle); 
toolId = doublePlus(toolId,appDataStruct.linkHandle); 
toolId = doublePlus(toolId,appDataStruct.secondaryAxesHandle);
