...
\input{Inhalt/notation}							% in dieser Datei Symbole und Abkürzungen eintragen
	\glsaddall
...
\input{Inhalt/gliederung}						% in der Datei "gliederung.tex" (zu finden im Unterordner "Inhalt" im Root-Ordner) die Inhaltskapitel einbinden
	...
	\input{Inhalt/anhang.tex}							% in der Datei "anhang.tex" (zu finden im Unterordner "Inhalt" im Root-Ordner) die Anhänge einbinden
\end{document}
